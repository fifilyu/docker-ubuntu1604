...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/usr/local/python-3.12.2' '--enable-optimizations' "
                ...
                "'PKG_CONFIG_PATH=:/root/downloads/pkgconfig'",
 ...
 'MODULE__CURSES_CFLAGS': '-D_GNU_SOURCE',
 'MODULE__CURSES_LDFLAGS': '-lncurses -ltinfo',
 'MODULE__CURSES_PANEL_CFLAGS': '-D_GNU_SOURCE -D_GNU_SOURCE',
 'MODULE__CURSES_PANEL_LDFLAGS': '-lpanel -lncurses -ltinfo',
