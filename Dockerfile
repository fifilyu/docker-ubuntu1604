...
# 常用编译环境组件
RUN ulimit -n 1024 && apt-get install -y gcc make libssl-dev
...
# 安装Python3.12
####################
RUN ulimit -n 1024 && apt-get install -y openssl libssl-dev libffi-dev zlib1g-dev tk-dev libsqlite3-dev libbz2-dev ncurses-dev liblzma-dev uuid-dev libreadline-dev libgdbm-dev
